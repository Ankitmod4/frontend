...
const EditBusinessProfile = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        const res = await axios.get(`https://influencal.influencialhub.com/api/business/${businessId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`https://influencal.influencialhub.com/api/business/${businessId}`, payload);
